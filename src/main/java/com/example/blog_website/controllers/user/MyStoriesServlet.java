...
public class MyStoriesServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Map<String, Object>> publishedPosts = blogPostDAO.getPostsByUser(user.getId(), "PUBLISHED");

        // Set the published posts in the request
        request.setAttribute("publishedPosts", publishedPosts);

        // Forward to the my stories page
        request.getRequestDispatcher("/WEB-INF/views/user/my-stories.jsp").forward(request, response);
    }
}
